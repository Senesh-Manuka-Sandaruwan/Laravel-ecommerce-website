                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                                ...
                                <div class="logo-wrapper">
                                    <a href="{{ route('welcome') }}" class="text-decoration-none">
                                        ...
                                        <h2 class="mt-3 mb-0 d-inline-block"
                                            style="font-family: 'Lora', serif; color: var(--primary-dark);">Crunchy Sweets</h2>
                                    </a>
                                </div>
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-4"
                                ...
                                <div class="card-header bg-gradient-primary py-3">
                                    <h3 class="text-center font-weight-light my-2"
                                        ...
                                        <i class="fas fa-cookie-bite me-2"></i>Welcome Back!
                                    </h3>
                                </div>
                                <div class="card-body p-4 p-md-5">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-check mb-4">
                                            <input class="form-check-input custom-checkbox" id="inputRememberPassword"
                            ...
                            <div class="text-center mt-4 mb-5">
                                <p class="small" style="color: var(--primary-dark);">© 2025 Sweet Delights. All rights
                                    reserved.</p>
                            </div>
                        </div>
                    </div>
