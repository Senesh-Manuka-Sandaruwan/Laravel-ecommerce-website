...
<body class="font-poppins">
    <!-- Navigation -->
    <nav class="bg-primary-light shadow-sm sticky top-0 z-50" style="color: #5D4037 !important;">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <div class="flex items-center">
                <a href="{{ route('user.home') }}" class="flex items-center">
                    ...
                    <span class="text-xl font-lora ">Crunchy Sweets</span>
                </a>
            </div>

            <div class="hidden md:flex items-center space-x-6">
                <a href="{{ route('user.home') }}"
                    class=" hover:text-black transition-colors duration-300">Home</a>
                <a class=" hover:text-black transition-colors duration-300" href="{{ route('about-us') }}"
                    onmouseover="highlightLink(this)" onmouseout="removeHighlight(this)">About Us</a>
                <a class=" hover:text-black transition-colors duration-300" href="{{ route('contact-us') }}" href="{{ route('contact-us') }}"
                    onmouseover="highlightLink(this)" onmouseout="removeHighlight(this)">Contact Us</a>

                <!-- Cart Icon with Counter -->
                <!-- <button id="cart-toggle" class="relative  hover:text-black transition-colors duration-300">
                    <i class="fas fa-shopping-cart text-xl"></i>
                    <span id="cart-count" style="background-color: #D81B60 !important;"
                        class="absolute -top-2 -right-2  text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                        {{ $cartCount ?? 0 }}
                    </span>
                </button> -->
    ...
    <footer class="bg-dark py-6 mt-12 text-white" style="background-color: #5D4037 !important;">
